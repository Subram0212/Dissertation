...
import overall_PS_moving_UGVUAV_scenario2_age_period as PS
import overall_PS_multiUGVstops_UGVUAVmoving_scenario2 as PS2
...
mission_points_df = pd.read_csv('Scenario 6 data points.csv')
...
ugv_stops_dict = {}
ugv_Stops = minimum_set_cover_UGV_hyperparam_refined_replanning.main(ordered_pts_rest_df, 'Case_Study_scenario6.csv', rs_num, visited_missions_so_far, current_loc)
