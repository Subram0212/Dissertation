...
def create_data_model(stp1_ugv_stop_list, sp3_end_point, stp2_ugv_stop_list, se_act_depart_time, recharge_time, visited_missions, num_uavs, added_mission_pts, Age_period):
    n_depot_1 = 6
    n_stop_2 = 6
    data = {}
    ...
    ugv_new_travel_time = ugv_distance_calc_auto.distance_btw_ugvstops(stp2_ugv_stop_list[0], stp1_ugv_stop) // ugv_velocity
...
def main(sp3_end_point, stp1_ugv_stop_list, stp2_ugv_stop_list, se_act_depart_time, recharge_time, visited_missions, num_uavs, added_mission_pts, Age_period):  # This is where optimization of UAV routes happen.
    ...
    data, veh_max_time, depotb_vel, ugv_vel, tw_dict, ugv_stops_pairs, ugv_travel_time, ugv_inter_locs = create_data_model(sp3_end_point, stp1_ugv_stop_list, stp2_ugv_stop_list, se_act_depart_time, recharge_time, visited_missions, num_uavs, added_mission_pts, Age_period)
    # [END data]
