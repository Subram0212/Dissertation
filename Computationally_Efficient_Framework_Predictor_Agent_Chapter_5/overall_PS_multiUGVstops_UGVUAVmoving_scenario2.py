...
import sp1_multiUGVstops_ateams_movingUGV_justend_rch_pts_scenario2 as sp1
# import sp1_multiUGVstops_ateams_movingUGV as sp1
import sp2_multiUGV_stops_ateams_movingUGV_justend_rch_pts_scenario2 as sp2
# import sp2_multiUGV_stops_ateams_movingUGV as sp2
import sp3_multiUGV_stops_ateams_movingUGV_justend_rch_pts_scenario2 as sp3
...
if __name__ == "__main__":
    ...
    param_list = [10, 5, 4, 5]  # optimal UGV solution for the reduced scenario - RS = 100
    ...
    num_uavs = 1
    ugv_stops_dict = {}
    mission_points_ordered_df = pd.read_csv('Scenario 6 ordered rest.csv')
