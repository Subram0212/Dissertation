...
def distance_from_depotB(position_1, position_2, df_list):
    # df = pd.read_excel('ARL corridor reduced points ordered DepotB.xlsx')
    # df = pd.read_csv('Scenario 3 ordered from depot.csv')
    # df_list = df.values.tolist()
    ugv_distance = 0
    df_list = [list(i) for i in df_list]
    for i in range(len(df_list)):
...
def distance_btw_ugvstops(position_1, position_2, df_list):
    # df = pd.read_excel('ARL corridor reduced points ordered.xlsx')
    # df = pd.read_csv('Scenario 3 ordered rest.csv')
    # df_list = df.values.tolist()
    ugv_distance = 0
...
def distance_from_depotB_btw_ugvstops(position_1, position_2, df_list):
    # df = pd.read_excel('ARL corridor reduced points ordered DepotB.xlsx')
    # df = pd.read_csv('Scenario 3 ordered from depot.csv')
    # df_list = df.values.tolist()
    ugv_distance = 0
