import pandas as pd
import numpy as np
import minimum_set_cover_UGV_hyperparam_refined_scenario3 as minimum_set_cover_UGV_hyperparam_refined
...
import sp1_multiUGVstops_ateams_movingUGV_justend_rch_pts_scenario3 as sp1
# import sp1_multiUGVstops_ateams_movingUGV as sp1
import sp2_multiUGV_stops_ateams_movingUGV_justend_rch_pts_scenario3 as sp2
# import sp2_multiUGV_stops_ateams_movingUGV as sp2
import sp3_multiUGV_stops_ateams_movingUGV_justend_rch_pts_scenario3 as sp3
...
def persistent_surveillance(param_list, num_uavs, ugv_stops_dict, ordered_pts_from_depot=None):
    mission_points = pd.read_csv('Scenario 7 data points.csv')
    ordered_pts_from_depot = pd.read_csv('Scenario 7 ordered from depot.csv')
    ordered_pts_rest = pd.read_csv('Scenario 7 ordered rest.csv')
    ordered_pts_from_depot_second = pd.read_csv('Scenario 7 ordered from depot second.csv')
...
if __name__ == "__main__":
    ...
    param_list = [7, 5, 2, 2]  # optimal UGV solution for the reduced scenario - RS = 100
    ...
    num_uavs = 1
    ugv_stops_dict = {}
    mission_points_ordered_df = pd.read_csv('Scenario 7 ordered rest.csv')
    ...
    ugv_Stops = minimum_set_cover_UGV_hyperparam_refined.main(mission_points_ordered_df, 'Case_Study_scenario7.csv')
    # Updated UGV end pairs for re-planning
    # ugv_stops_dict = {}
