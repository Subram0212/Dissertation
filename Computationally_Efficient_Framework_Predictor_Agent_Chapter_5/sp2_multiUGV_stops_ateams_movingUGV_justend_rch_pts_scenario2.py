...
def print_solution(data, manager, routing, solution):  # Prints the UAV optimization solution output on the console.
    ...
    if data["end_loc"] != data["hyperparam_end_loc"]:
        df2_no_mid.to_excel('Sub_problem2_scenario2_ensemble_1.xlsx', index=False, engine='openpyxl')
    else:
        df2_no_mid.to_excel('Sub_problem2_scenario2_ensemble_2.xlsx', index=False, engine='openpyxl')
