...
with open('output_10_scn3_kNN.txt', 'r') as file:
    for line in file:
        values = line.split()
        if len(values) >= 5:
...
ugv_stops_dict = {}
ugv_Stops = minimum_set_cover_UGV_hyperparam_refined_scenario3.main(ordered_pts_rest_df, 'Case_Study_scenario7.csv')
...
plt.savefig('Confusion matrix and scores/confusion_matrix - kNN, scenario 3 and seed 10.pdf', format='pdf')
...
plt.savefig('Confusion matrix and scores/ROC curve - kNN, scenario 3 and seed 10.pdf', format='pdf')
