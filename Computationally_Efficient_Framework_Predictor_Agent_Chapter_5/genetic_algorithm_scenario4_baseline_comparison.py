...
import numpy as np
import overall_PS_multiUGVstops_UGVUAVmoving_scenario4
import random
...
def ga_evaluation1(X):
    ...
    for j in range(len(sorted_initial_population_copy)):
        ...
        global_f, global_t, global_tt, global_depotvel, global_ugvvel, global_track_node_age, global_route_dict, global_route_dict2, global_route_dict3, global_sp_feas_list, global_total_cost = overall_PS_multiUGVstops_UGVUAVmoving_scenario4.persistent_surveillance(param_list, num_uavs, ugv_stops_dict)
