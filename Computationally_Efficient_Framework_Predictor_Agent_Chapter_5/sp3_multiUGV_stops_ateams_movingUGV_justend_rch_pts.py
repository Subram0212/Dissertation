...
def create_data_model(sp3_end_point, stp1_ugv_stop_list, stp2_ugv_stop_list, se_act_depart_time, recharge_time, ugv_stops_dict, visited_missions, num_uavs):
    n_depot_1 = 6
    n_stop_2 = 6
    data = {}
    ...
    for i in range(len(ordered_mission_pts_stp1_stop)):
        ...
        if ordered_mission_pts_stp1_stop[i] == sp3_end_point[0]:
            ...
            continue
    # mission_locations.extend(dynamic_added_pair)
...
def main(sp3_end_point, stp1_ugv_stop_list, stp2_ugv_stop_list, se_act_depart_time, recharge_time, ugv_stops_dict, visited_missions, num_uavs):  # This is where optimization of UAV routes happen.
    ...
    data, veh_max_time, depotb_vel, ugv_vel, tw_dict, ugv_stops_pairs, ugv_travel_time, ugv_inter_locs = create_data_model(sp3_end_point, stp1_ugv_stop_list, stp2_ugv_stop_list, se_act_depart_time, recharge_time, ugv_stops_dict, visited_missions, num_uavs)
    # [END data]
