...
import sp1_scenario2_age_period as sp1
import sp2_scenario2_age_period as sp2
import sp3_scenario2_age_period as sp3
...
mission_points = pd.read_csv('Scenario 6 data points.csv')
