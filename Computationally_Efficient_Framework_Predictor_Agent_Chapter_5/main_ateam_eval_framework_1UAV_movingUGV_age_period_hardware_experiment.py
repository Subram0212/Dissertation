...
import overall_PS_moving_UGVUAV_hardware_experiment_age_period as PS
...
ugv_stops_dict = {}
ugv_Stops = minimum_set_cover_UGV_hyperparam_refined_replanning.main(ordered_pts_rest_df, 'Hardware experimental scaled up case study scenario in miles.csv', rs_num, visited_missions_so_far, current_loc)
...
for i in range(len(ugv_Stops)):
    ...
    cnt += 1
stops_comb_len = len(ugv_stops_dict)
