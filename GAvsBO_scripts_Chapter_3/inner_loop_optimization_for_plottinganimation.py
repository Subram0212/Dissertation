...
def create_data_model(ugv_stop_loc, depot_to_first_stop_vel, ugv_vel, NW_stop, SE_stop, strt_pt):
    n_depot_1 = 6
    n_stop_1 = 6
    n_stop_2 = 6
    n_depot_2 = 6
    ...
    if strt_pt == 2:
        ...
        print(return_time_1, return_time_2)
        print("Return time: {}".format(return_time_1+return_time_2))
        ...
        data["initial_routes"] = [[25, 26, 27, 28, 29, 12, 30, 31, 32, 33]]
...
def print_solution(data, manager, routing, solution):  # Prints the UAV optimization solution output on the console.
    ...
    # df2.to_excel('GA generation dataset/plotting optimized parameter data_depotbstart.xlsx', index=False, engine='openpyxl')
...
def main(ugv_stop_loc, depot_to_first_stop_vel, ugv_vel, NW_stop, SE_stop, strt_pt):  # This is where optimization of UAV routes happen.
    """Entry point of the program."""
    # Instantiate the data problem.
    # [START data]
    data, veh_max_time, depotb_vel, ugv_vel, pen, tw_dict, stop1, stop2 = create_data_model(ugv_stop_loc, depot_to_first_stop_vel, ugv_vel, NW_stop, SE_stop, strt_pt)
    # [END data]
    ...
    #     return (1 * weighted_time_cost) + ((1 - 1) * energy_cost)
    #
    ...
    if solution:
        ...
        # print(route)
        return obj_val, veh_max_time, total_dist, total_time, depotb_vel, ugv_vel, pen, tw_dict, route_dict, cnt_list_stop1, cnt_list_stop2, stop1, stop2
    else:
...
#     param_list = [58, 13, 13, 3, 3, 2]
#     fitness_val, max_time, total_distance, total_time, depotb_vel, ugv_vel, penalty, tw_dict, route_dict, cn1, cn2, stop_1, stop_2 = main(param_list[0], param_list[1], param_list[2], param_list[3], param_list[4], param_list[5])
#     wt_time_1 = param_list[3] * 60
#     wt_time_2 = param_list[4] * 60
#     count_1 = 0
#     count_2 = 0
#     for key in route_dict:
#         if key in [1, 2, 3, 4, 5, 6]:
#             count_1 += 1
#             if route_dict[key] < tw_dict[key][1] and count_1 <= max(cn1):
#                 wt_time_1 -= (tw_dict[key][1] - route_dict[key])
#         elif key in [7, 8, 9, 10, 11, 12]:
#             count_2 += 1
#             if route_dict[key] < tw_dict[key][1] and count_2 <= max(cn2):
#                 wt_time_2 -= (tw_dict[key][1] - route_dict[key])
#     if stop_2:
#         wt_time_2 = 180 // 60
#     if stop_1:
#         wt_time_1 = 180 // 60
#     param_list[3] = wt_time_1 // 60
#     param_list[4] = wt_time_2 // 60
#     fitness_val, max_time, total_distance, total_time, depotb_vel, ugv_vel, penalty, tw_dict, route_dict, cn1, cn2, stop_1, stop_2 = main(param_list[0], param_list[1], param_list[2], param_list[3], param_list[4], param_list[5])
#     print(wt_time_1//60, wt_time_2)
