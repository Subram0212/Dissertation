...
df = pd.read_excel('UIC_UMD_collab_animation_firststage_data_2UAVs_1UGV_part2.xlsx')
# print(df)
...
new_list = [[i, 0, 0] for i in range(263)]
# print(new_list)
...
ugv_list = [[0, 0] for j in range(263)]
...
df5.to_excel('data_to_interpolate_UIC_UMD_depotbstrt_2UAVs1UGV_part2.xlsx', index=False, engine='openpyxl')
