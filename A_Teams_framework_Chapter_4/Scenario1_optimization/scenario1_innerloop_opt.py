...
def create_data_model(ugv_stop_loc, NW_stop, SE_stop, strt_pt, num_stops, ugv_stops_distance_dict):
    n_depot_1 = 6
    n_stop_1 = 6
    n_stop_2 = 6
    n_depot_2 = 6
    ...
    if strt_pt == 2:
        ...
        if num_stops == 2:
            ...
            ugv_stops_dict = scenario_1_data_processing.scenario_1_data_processing(num_stops)
            data, veh_max_time, depot_b_to_nw_velocity, velocity, pen = multipleUGV_stops_locs_scenario1.ugv_data(strt_pt, start_loc, num_stops, ugv_stop_loc, ugv_stops_dict, NW_stop, SE_stop, ordered_mission_pts_stp1_stop, ordered_mission_pts_stp2_stop, ugv_stops_distance_dict)
            return data, veh_max_time, depot_b_to_nw_velocity, velocity, pen
    elif strt_pt == 3:
        print("Start point is: {}".format(strt_pt))
        ...
        if num_stops == 2:
            ...
            print(data["stations"])
            print(data["visits"])
            return data, veh_max_time, depot_c_to_nw_velocity, velocity, pen
        else:
            ugv_stops_dict = scenario_1_data_processing.scenario_1_data_processing(num_stops)
            data, veh_max_time, depot_b_to_nw_velocity, velocity, pen = multipleUGV_stops_locs_scenario1.ugv_data(strt_pt, start_loc, num_stops, ugv_stop_loc, ugv_stops_dict, NW_stop, SE_stop, ordered_mission_pts_stp1_stop, ordered_mission_pts_stp2_stop, ugv_stops_distance_dict)
            return data, veh_max_time, depot_b_to_nw_velocity, velocity, pen
...
def main(ugv_stop_loc, NW_stop, SE_stop, strt_pt, num_stops, ugv_stops_distance_dict):  # This is where optimization of UAV routes happen.
    """Entry point of the program."""
    # Instantiate the data problem.
    # [START data]
    data, veh_max_time, depotb_vel, ugv_vel, pen = create_data_model(ugv_stop_loc, NW_stop, SE_stop, strt_pt, num_stops, ugv_stops_distance_dict)
    # [END data]
    ...
    if solution:
        ...
        return obj_val, veh_max_time, total_dist, total_time, depotb_vel, ugv_vel, pen
    else:
...
#     graph = main(2, 8, 42, 5, 2, ugv_stops_dict)
