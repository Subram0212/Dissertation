...
def main(ugv_stop_loc, NW_stop, SE_stop, strt_pt, ugv_stops_distance_dict) -> object:  # This is where optimization of UAV routes happen.
...
if __name__ == '__main__':
    ...
    graph = main(92, 3, 6, 5, ugv_stops_dict)
