...
def main(params, ugv_stops_dict, ugv_stops_distance_dict):  # This is where optimization of UAV routes happen.
...
if __name__ == '__main__':
    ...
    graph = main([8, 5, 5, 5], ugv_dict, ugv_stops_dict)
