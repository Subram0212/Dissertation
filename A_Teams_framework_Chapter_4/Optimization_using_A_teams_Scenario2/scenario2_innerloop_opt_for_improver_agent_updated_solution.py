...
#     # df = pd.read_csv('Scenario 2 orientation change data points.csv')
#     df = pd.read_csv('Scenario 2 orientation change data points midpt change.csv')
...
#     ugv_dict = scenario_2_data_processing.scenario_1_data_processing()
#     graph = main([7, 26, 31, 4], ugv_dict, ugv_stops_dict)